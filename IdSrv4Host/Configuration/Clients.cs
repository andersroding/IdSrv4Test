        ...
        public static IEnumerable<Client> Get()
        {
            return new List<Client>
            {
                ...
                new Client
                {
                    ...
                    RedirectUris =
                    {
                        "https://vgids4.anders.test/web/callback.html"
                    },
                    PostLogoutRedirectUris = { "https://vgids4.anders.test/web/index.html" },
                    AllowedCorsOrigins =     { "https://vgids4.anders.test/web" },
